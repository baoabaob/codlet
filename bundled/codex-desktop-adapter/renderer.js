...
function createAdapter(connection, context, { compatibilityProvided = false } = {}) {
    ...
    const api = Object.freeze({ api: 1, status: () => { check(); return status(); }, read, write, readEvents, onEvent, registerPreSubmit, listInterceptors });
    function dispose() {
