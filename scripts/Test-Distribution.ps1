...
$exampleCandidates = @(
    ...
    @{ Directory = 'github-release-check/v1'; Id = 'dev.example.github-release-check' },
    @{ Directory = 'github-release-check/v2'; Id = 'dev.example.github-release-check' },
...
function Test-Manifest([string]$Directory) {
    ...
    foreach ($required in @(
        ...
        'docs/REMAINING_ACCEPTANCE_MANUAL_2026-09-12.md', 'docs/COMMUNITY_PLUGINS.md',
        'scripts/Build-PluginPackage.ps1',
        'examples/github-release-check/v1/codlet.json', 'examples/github-release-check/v1/codlet-package.json', 'examples/github-release-check/v1/LICENSE.txt',
        'examples/github-release-check/v2/codlet.json', 'examples/github-release-check/v2/codlet-package.json', 'examples/github-release-check/v2/LICENSE.txt',
